...
/**
 *
 * http://java67.blogspot.de/2015/01/how-to-sort-hashmap-in-java-based-on.html
 */
public class HashMapSorting {
    ...
    public static void main(String args[]) throws ParseException {
        ...
        listOfEntries.stream().forEach((entry) -> {
        ...
        entrySetSortedByValue.stream().forEach((mapping) -> {
            System.out.println(mapping.getKey() + " ==> " + mapping.getValue());
        });
    }
