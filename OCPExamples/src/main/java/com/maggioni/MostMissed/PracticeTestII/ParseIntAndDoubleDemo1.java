...
public class ParseIntAndDoubleDemo1 {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("Integer.parseInt(\"null\") " + Integer.parseInt(null)); // java.lang.NumberFormatException: null
        ...
        System.out.println("Double.parseDouble(\"1234583\") "+  Double.parseDouble("1234583"));
