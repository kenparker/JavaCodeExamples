...
public class ComparatorUsingLambdas{
    ...
    public static void main(String args[]) {
       ...
       Collections.sort(onlineCourses, TITLE_COMPARATOR);
        ...
        Collections.sort(onlineCourses, (c1, c2) -> c2.getPrice().compareTo(c1.getPrice()));
        System.out.println(onlineCourses);
       
        System.out.println("Sorting list in decreasing order of title, using lambdas");
        Collections.sort(onlineCourses, (c1, c2) -> c2.getTitle().compareTo(c1.getTitle()));
        System.out.println(onlineCourses);
        
        System.out.println("Sorting objects in decreasing order of title, using comparator");
        Collections.sort(onlineCourses, Comparator.comparing(TrainingCourses::getTitle).reversed());
        System.out.println(onlineCourses);
        System.out.println("Sorting objects in decreasing order of price, using comparator");
        Collections.sort(onlineCourses, Comparator.comparing(TrainingCourses::getPrice).reversed());
        System.out.println(onlineCourses);
    }
}
